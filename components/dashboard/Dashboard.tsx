...
import { UserButton, Show, useAuth, UserAvatar  } from '@clerk/nextjs'
...
//   const visibleLog = showAllSessions ? sortedLog : sortedLog.slice(0, 6)
  ...
  const stats = [
    { label: 'Current Streak',     value: `0 days`,    icon: '🔥', accent: ORANGE },
    { label: 'Workouts This Week', value: `1 / 7`,   icon: '⚡', accent: '#f2c94c' },
    { label: 'Total Workouts',     value: 0,   icon: '✓',  accent: '#82d296' },
